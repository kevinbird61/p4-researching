...
/**
 * Implementation of a pipeline interpreter for p4 program
 */
public final class PipelineInterpreterImpl
    ...
    implements PiPipelineInterpreter {
        ...
        private static final String INGRESS = "Basic_ingress";
        private static final String IPV4_LPM = "ipv4_lpm";
        ...
        private static final BiMap<Integer, PiTableId> TABLE_MAP = 
            new ImmutableBiMap.Builder<Integer, PiTableId>()
                .put(0, TABLE_IPV4_LPM_ID)
                .build();

        private static final BiMap<Integer, PiTableId> CRITERION_MAP = 
        ...
        public PiAction mapTreatment(TrafficTreatment treatment, PiTableId piTableId)
            ...
            if (piTableId != TABLE_IPV4_LPM_ID) {
                throw new PiInterpreterException(
                        "Can map treatments only for 'ipv4_lpm' table");
            }
